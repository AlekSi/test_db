...
func (s Staff) String() string {
	...
	res[4] = "Picture: " + reform.Inspect(s.Picture, true)
	res[5] = "Email: " + reform.Inspect(s.Email, true)
	res[6] = "StoreID: " + reform.Inspect(s.StoreID, true)
	res[7] = "Active: " + reform.Inspect(s.Active, true)
	res[8] = "Username: " + reform.Inspect(s.Username, true)
	res[9] = "Password: " + reform.Inspect(s.Password, true)
	res[10] = "LastUpdate: " + reform.Inspect(s.LastUpdate, true)
